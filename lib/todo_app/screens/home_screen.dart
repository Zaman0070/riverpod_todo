...
import 'package:flutter_riverpod_todo_app/todo_app/widgets/app_background.dart';
import 'package:flutter_riverpod_todo_app/todo_app/widgets/display_list_of_tasks.dart';
...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final inCompletedTasks = incompltedTask(taskState.tasks, ref);
